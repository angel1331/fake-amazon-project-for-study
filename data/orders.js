...
import { products, getProduct, loadProductsFetch } from "./products.js";
...
export function renderCartQuantityFromStorage() {
  ...
  if (cartQuantityEl) {
    cartQuantityEl.innerHTML = savedQuantity;
  }
}
...
async function loadPageOrders() {
  await loadProductsFetch();

  let ordersHTML = '';

  orders.forEach((order) => {
    const orderTimeString = dayjs(order.orderTime).format('MMMM D HH:mm');
    ordersHTML += `
